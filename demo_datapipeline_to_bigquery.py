...
def get_data_from_mysql(transaction_path):
    ...
    audible_transaction = mysqlserver.get_pandas_df(sql = "SELRCT * FROM audible_transaction")
...
def merge_data(transaction_path,conversion_rate_path,output_path):
    ...
    with DAG(
        ...
        t4 = BashOperator(
            task_id="load_to_bq",
            bash_command="bq load --source_format=csv --autodetect [DATASET].[TABLE_NAME]  gs:// [GCS_BUCKET]/data/output.csv"
        )
